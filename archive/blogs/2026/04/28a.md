...
![Chapter's page early look](./28a-images/01.png)
...
![Question revision page early look](./28a-images/04.png)

Here is an early screenshot of the `/chapters/{id}/questions` page:  
![Chapter questions page early look](./28a-images/05.png)
...
![Admin user page](./28a-images/06.png)
...
![Questions page](./28a-images/10-mobile.jpg)
...
![Engagement Count](./28a-images/19.png)
