...
1. [ FIMFiction Cookie](https://github.com/SilkRose/Pony/tree/mane/archive/code/fimfic-cookie): to get a cookie for use with the cover updater.
2. [FIMFiction Cover](https://github.com/SilkRose/Pony/tree/mane/archive/code/fimfic-cover): to update the story's cover.
...
4. [FIMFiction April Fools](https://github.com/SilkRose/Pony/tree/mane/archive/code/fimfic-april-fools-2024): to bring it all together and send out API requests.
