# FixFiction 2.0: More Fixes, More Embeds, More Options

After months of work, a new major version of [FixFiction](https://github.com/SilkRose/FixFiction) is online and available for use. Actually, everyone who's been using FixFiction for the last two weeks or so has been using FixFiction v2.0, probably without noticing. This is good!
...
- ### Chapters
  ...
  Examples:
  - Story "[Changes.](https://www.fimfiction.net/story/579410/changes)" --> Chapter "[One.](https://www.fimfiction.net/story/579410/1/changes/one)"
    `https://www.fixfiction.net/story/579410/1/changes/one`  
    ![One.](./10a-images/01.png)
    
  - Story "[Changes.](https://www.fimfiction.net/story/579410/changes)" --> Chapter "[Two.](https://www.fimfiction.net/story/579410/2/changes/two)"
    `https://www.fixfiction.net/story/579410/2/`  
    ![Two.](./10a-images/02.png)
    
  - Story "[Changes.](https://www.fimfiction.net/story/579410/changes)" --> Chapter "[Three.](https://www.fimfiction.net/story/579410/3/changes/three)" 
...
- ### Bookshelves
  ...
  Examples:
  - Bookshelf "[Story Recommendations](https://www.fimfiction.net/bookshelf/2812367/story-recommendations)"
    `https://www.fixfiction.net/bookshelf/2812367/story-recommendations`  
    ![Story Recommendations](./10a-images/04.png)
    
  - Bookshelf "[My Shit](https://www.fimfiction.net/bookshelf/717893/my-shit)"
...
- ### Groups
  ...
  Examples:
  - Group "[A Thousand Words](https://www.fimfiction.net/group/216361/a-thousand-words)"
    `https://www.fixfiction.net/group/216361/a-thousand-words`  
    ![A Thousand Words](./10a-images/06.png)
    
  - Group "[Anterlot public Library](https://www.fimfiction.net/group/215528/anterlot-public-library)"
...
- ### Forum Threads
  ...
  Examples:
  - Group "[A Thousand Words" --> Forum Thread "A Thousand Words Contest IV (2025 May 25 - Jul 06)](https://www.fimfiction.net/group/216361/a-thousand-words/thread/561086/a-thousand-words-contest-iv-2025-may-25-jul-06)"
  ...
  - Group "A Thousand Words" --> Forum Thread "[and CLOSED!](https://www.fimfiction.net/group/216361/a-thousand-words/thread/562941/and-closed)"
...
- Blogs, Chapters, and Stories have a new option `tag`, accepting a boolean. When true, it includes tags in the embed.
  ...
  Blog: "[New chapter of “Road To Glory” is out!](https://www.fimfiction.net/blog/1127623/new-chapter-of-road-to-glory-is-out)"
...
- A new `color` value is `random`, which selects a random mane 6 colour to use as the embed's highlight colour. This value also has the alias `ran`.
  ...
  User: "[pneu](https://www.fimfiction.net/user/616548/pneu)"
...
- A new `color` value is `modulo`, which applies a modulo function on the target's ID to select a mane 6 colour. Practically speaking it is similar to `random`, but the colour selected for a specific item will not change over time. This value also has the alias `mod`.
  ...
  User "[Math Spook](https://www.fimfiction.net/user/612387/Math+Spook)"
...
- A new `color` value is `founder`, applicable to Groups and Forum Threads. This will take the colour of the user who founded the relevant group and use it for the embed.
  ...
  Group: "[Harmony Reviews](https://www.fimfiction.net/group/217953/harmony-reviews)"
...
- Stat numbers like view count, word count, etc. are now formatted as they are on FimFiction.
  ...
  Story: "[Stormy Affair](https://www.fimfiction.net/story/553709/stormy-affair)"
...
- If a FixFiction link points to a valid destination but has syntax errors, the embed succeeds with an appended error message.
  ...
  User: "[knighty](https://www.fimfiction.net/user/1/knighty)"
  `https://www.fixfiction.net/user/1/knighty?info=ture`  
  ![knighty](./10a-images/15.png)
  
- If a FixFiction link causes a fatal error, it will embed an error message and a link to support pages.
  
  Story: \[unpublished story\]
  `https://www.fixfiction.net/story/552650`  
  ![unpublished story](./10a-images/16.png)
...
- Some Fimfiction links that may appear valid will actually lead to 404 pages. Typically these follow the pattern of a resource endpoint where the ID is supplied without a trailing `/`. For example:
  ...
  User: "[AtomicGlow](https://www.fimfiction.net/user/90142/AtomicGlow)"
  `https://www.fimfiction.net/user/90142`
  (This native Fimfiction link leads to a 404 page.)
...
Everything above this was written by [PseudoBob Delightus](https://www.fimfiction.net/user/12771/PseudoBob+Delightus). Who I'd like to give a massive thanks to. You did an amazing job Bob, thank you.

As with last time, I wanted to include smaller writers, so, go check them out from the examples above.

I still have more planned for FixFiction, specifically non-embed stuff. I won't be working on anything immediately, but look forward to 3.0 around the end of this year, start of next year.

FixFiction 1.0 had 1.2k lines of code, with 106 commits. FixFiction 2.0 is 3.5k lines of code, with 231 commits.
