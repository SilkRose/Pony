...
You can also use `image` instead of cover, I will be using `cover` for stories, and `image` for users and blogs going forward, but know they are interchangeable.
